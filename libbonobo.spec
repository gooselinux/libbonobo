...
Obsoletes: bonobo-activation < %{version}-%{release}
...
# From 2.3, libbonobo swallowed bonobo-activation
Obsoletes: bonobo-activation-devel < %{version}-%{release}
...
find $RPM_BUILD_ROOT -name bonobo-echo-2 -delete
...
* Fri Jan 29 2010 Ray Strode <rstrode@redhat.com> 2.24.2-3
Resolves: #560100
- spec file tweaks

* Tue Oct  6 2009 Matthias Clasen <mclasen@redhat.com> - 2.24.2-2
